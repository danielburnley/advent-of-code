defmodule AdventOfCode.DaySix do
  ...
  defmodule PartTwo do
    def solve(input, grid \\ get_grid()) do
      ...
      |> _solve(grid)
      |> List.flatten
      |> Enum.reduce(0, fn({i, _}, x) -> x + i end)
    end
    ...
    defp update_light(:on, {l, i}), do: {l + 1, i}
    defp update_light(:off, {0, i}), do: {0, i}
    defp update_light(:off, {l, i}), do: {l - 1, i}
    defp update_light(:toggle, {l, i}), do: {l + 2, i}
